...
def convert_file(input_file, output_file)
    with concurrent.futures.ThreadPoolExecutor() as executor
        ...
        if file_extension == 'json'
            ...
            print(fCan't load the file with this format {file_extension})
            return
        ...
        if output_extension == 'json'
            ...
            print(fCan't convert to file with this format {output_extension})
            return

    print(fFile {input_file} was converted to format {output_extension} and saved as {output_file}.)
